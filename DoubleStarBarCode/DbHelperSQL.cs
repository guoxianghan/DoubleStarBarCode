...
namespace CommonHelper
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        // private static string connString = (ConfigurationManager.ConnectionStrings["codingManagement"].ToString());
        private static string connString = ConfigurationManager.ConnectionStrings["local"].ToString();
        ...
        public static void SqlBuckCopy(DataTable dt, string tableName, params SqlBulkCopyColumnMapping[] map)
        {
            SqlBulkCopy bulkCopy = new SqlBulkCopy(connString);
            bulkCopy.DestinationTableName = tableName;
            foreach (SqlBulkCopyColumnMapping item in map)
            {
